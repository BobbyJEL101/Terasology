...
public class Chunk extends StaticEntity implements Comparable<Chunk>, Externalizable {
    ...
    private boolean _subMeshVisible[] = new boolean[VERTICAL_SEGMENTS];
    /* ------ */
    ...
    public enum RENDERING_RESULT {
        SUCCESS, OCCLUSION_CULLED, NOT_READY, EMPTY
    }
    ...
    public void setSubMeshVisible(int subMesh, boolean visible) {
        _subMeshVisible[subMesh] = visible;
    }

    public boolean isSubMeshVisible(int subMesh) {
        return _subMeshVisible[subMesh];
    }
